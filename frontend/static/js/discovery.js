...
(function () {
  ...
  function highlightName(name, term) {
    ...
    var idx = text.toLowerCase().indexOf(escapedTerm.toLowerCase());
    if (idx === -1) return text;
    return text.slice(0, idx) + '<mark>' + text.slice(idx, idx + escapedTerm.length) + '</mark>' + text.slice(idx + escapedTerm.length);
  }
